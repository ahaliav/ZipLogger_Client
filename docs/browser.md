...
Capture uncaught errors, unhandled promise rejections, and custom events from web apps, with a
...
- Batching defaults are browser-tuned: 20 events/request, 3 s linger, 2 retries, 1,000-event buffer.
